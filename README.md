...
**亮色主题 (Light)**
- 主色调: `#2C3E50` (深邃蓝灰，代表知识的深度)
- 次要色: `#34495E` (稍浅的蓝灰)
- 强调色: `#E74C3C` (温暖的红，用于重点标记)
- 背景色: `#FAFAF8` (温暖的米白，模拟纸张)
- 文字色: `#333333` (柔和的深灰)
- 边框色: `#E8E8E6` (微妙的分隔线)
...
- 阅读背景设置 (应用范围：网页背景、文本区域、表格):
  - 纯色背景: 米白、米黄、草绿、淡蓝、杏仁、淡粉、淡紫、暖灰
  - 文艺图案: 圆点、横线、网格、菱形
  - 国风图案: 云纹、水波、竹节、鱼鳞 (SVG矢量)
  - 信笺背景: 笔记本、康奈尔笔记、法律纸、方格纸
...
### 背景图案实现
- **纯色**: 直接应用背景色
- **文艺图案**: CSS渐变 (radial-gradient, repeating-linear-gradient, linear-gradient)
- **国风图案**: SVG data URI (云纹、水波、竹节、鱼鳞)
- **信笺背景**: CSS线性渐变 (笔记本横线、康奈尔网格、法律纸、方格纸)
